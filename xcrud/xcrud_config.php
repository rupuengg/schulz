...
{
    // default connection
    public static $dbname = 'merascho_demo'; // Your database name
    public static $dbuser = 'root'; // Your database username
 //   public static $dbpass = 'H?t37Vkxd*VH'; // // Your database password
    ...
    public static $sess_expire = 30000; // Specifies the lifetime of the session, as well as the existence of a key safety (for example, the maximum edit-saving timeout).
    ...
    public static $alt_lifetime = 30000; // in minutes, maximum time between requests when instance's data can be valid
