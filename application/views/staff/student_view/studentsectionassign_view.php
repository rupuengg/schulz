...
<!DOCTYPE html>
<html lang="en">
       <title>Student Section Assign</title>
    <?php
                            ...
                            <div class="col-md-8">
                                <div class="card card-bordered style-primary">
                                    <div class="card-head">
                                        ...
                                        <header><i class="fa fa-fw fa-tag"></i>Student Section Assign</header>
                                    </div><!--end .card-head -->
                                    <div class="card-body style-default-bright">
                                        <div class="form-group">
                                            <select id="dd_section_type" onchange="changeURL(this)" name="select1" class="my-select">
                                                ...
                                                foreach ($sectionList as $val) {
                                                    ?>
                                                    <option <?php echo ($class) == $val['id'] ? 'selected' : ''; ?> value="<?php echo $val['id']; ?>"><?php echo $val['standard'] . ' ' . $val['section']; ?></option>
                                                    <?php
                                                }
                                                ?>
                                        ...
                                        $xcrud->columns("firstname,adm_no,section_id,house");
                                        $xcrud->fields("section_id");
                                        $xcrud->unset_title();
                                        $xcrud->relation("section_id", "section_list", "id", array("standard","section"),"","'order'");
                                        
                                    
                                        $xcrud->label("section_id", "Section");
                                        $xcrud->label("firstname", "Student Name");
                                        $xcrud->label("admn_no", "Admission No.");
                            ...
                            <div class="col-md-4">
                                <div class="card card-bordered style-primary">
                                    ...
                                    <div class="card-body style-default-bright">
                                        ...
                                        Please select a class from the drop down list.You can see all the students of the selected class along with the admission no, house and assigned section. 
    ...
    <script>
        function changeURL(element) {
            if (element.value == '') {
                ...
                window.location = "<?php echo base_url(); ?>index.php/staff/studsectionassign/" + element.value;
            }
        }
