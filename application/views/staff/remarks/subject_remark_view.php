...
<html lang="en">
    ...
    <body class="menubar-hoverable header-fixed ">
        ...
        <div id="base" ng-app="RemarkEntry" ng-cloak ng-class="cloak">
                                    ...
                                    <div class="card">
                                        <div class="card card-bordered style-primary" >                                                                             
                                            <div class="card-head card-head-sm">
                                                <header><i class="fa fa-fw fa-tag"></i>Subject Remarks Entry</header>
                                            </div><!--end .card-head -->
                                        </div>
                                        <div class="card-body style-default-bright">
                                            <div class="col-md-12">
                                                    <div class="form-group">
									<select id="select1" ng-change="myChangeEvent()" ng-model="mySelectedData" ng-app ng-init="mySelectedData = 'NA'" class="form-control" required="" aria-required="true">
										<option value="NA">Please Select Subject</option>
                                                                                <option value='{{tempData}}' ng-repeat="tempData in data" value="">{{tempData.class}} {{tempData.subject}}</option>
									</select>
						    </div>
                                            </div>
                                            
                                            <div class="col-md-7" ng-show="mySelectedData!='NA'">
                                                <table class="table table-condensed no-margin">
                                                    ...
                                                    <tbody>
                                                        <tr ng-repeat="std in stddata">
                                                            ...
                                                            <td><textarea type="text" ng-blur="myFocusout()" ng-focus="myFocusEvent(std)" ng-model="std.remark_filled" class="form-control" id="regular13"></textarea></td>
                                            ...
                                            <div ng-show="showstddetail" class="col-lg-4 col-sm-7">
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                                    ...
                                                                    <div class="timeline-entry">
                                                                        ...
                                                                        <div class="card style-default-light">
                                                                            <div class="card-head">
                                                                                ...
                                                                                <div class="tools">
                                                                                    <div class="btn-group">
                                                                                        <a class="btn btn-icon-toggle btn-close"><i class="md md-close" id="{{ss.id}}" ng-click="deleteRemark($event,$index)"></i></a>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                            <!--//{{ss.staffname}}-->
                                                        ...
                                                        <div class="alert alert-danger" role="alert" ng-show="selectedstd.remarkDetail.length==0">
