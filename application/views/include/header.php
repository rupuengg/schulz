            ...
            <ul class="header-nav haeader-nav-options">
                ...
                <li class="header-nav-brand" >
                    <div class="brand-holder">
                        <a href="<?php echo base_url();?>/index.php/staff/staffdashboard">
                            <img style="width: 100px;" src="<?php echo base_url() .$this->session->userdata('brand_logo') ?>"/> 
                            <span class="text-lg text-bold text-info " style="position:relative;top: 12px;">||  <?php echo $this->session->userdata('brand_name') != false ? $this->session->userdata('brand_name') : "" ?></span>
                        </a>
                    </div>
                </li>
            </ul>
                ...
                <li class="dropdown">
                    <a href="javascript:void(0);" class="dropdown-toggle ink-reaction" data-toggle="dropdown">
                        ...
                        <span class="profile-info">
                            <?php echo $this->session->userdata('staff_name').' ('.$this->session->userdata('staff_desig').')' ; ?>
