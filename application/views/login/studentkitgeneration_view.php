                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group" >
                                                    ...
                                                    <select   ng-model="studlist" ng-change="SectionStud()" id="dd_section_type" ng-selected="studlist === secObj.id" ng-init="studlist = 0">
                                                ...
                                                <table class="table table-condensed no-margin">
                                                    ...
                                                    <tbody>
                                                        <tr ng-repeat="studObj in mystudents">
                                                            ...
                                                            <td title="{{'username: '+studObj.username +', password: '+ studObj.password}}"><a class="tile-content ink ink-reaction" href="<?php echo base_url(); ?>index.php/staff/studentprofile/{{studObj.adm_no}}">{{studObj.name}}</a></td>
                                                            ...
                                                            <td><a  href="javascript:void(0);" class="btn ink-reaction btn-raised btn-xs btn-primary" ng-click="edit(studObj.adm_no)" type="button"><i class="fa fa-edit"></i></a>
                                                                <!--<p ng-show="studObj.adm_no == ObjPwd.adm_no" class="text-danger">{{studObj.password_reset=='NO'?"":"Password reset s    uccessfully"}}</p>-->
                                                            </td>
                                                        </tr>
