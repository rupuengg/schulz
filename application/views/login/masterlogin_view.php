...
<html lang="en">
    <head>
        ...
        ?>
        <link rel="stylesheet" href="<?php echo base_url(); ?>/asset/css/angucomplete.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>/asset/css/structure.css">
        <link rel="stylesheet" href="<?php echo base_url(); ?>/asset/fonts/bariol/bariol.css"/>
                                                ...
                                                <div class="form">
                                                    <div class="form-group no-margin no-padding">
                                                        <select ng-model="schoolId" id="sel1" class="form-control">
                                                            ...
                                                            <option ng-repeat="school in schoolList"  value="{{school.id}}">{{school.school_name}}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
