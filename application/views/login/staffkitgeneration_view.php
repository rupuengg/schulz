...
<html lang="en">
                                                ...
                                                <table class="table table-condensed no-margin">
                                                    ...
                                                    <tbody>
                                                        <tr ng-repeat="staffObj in mainstaff">
                                                            ...
                                                            <td><img class="img-circle width-1" src="<?php echo base_url() . "index.php/staff/getphoto/" . "{{staffObj.staff_id}}/THUMB"; ?>" alt=""></td>
                                                            <td title="{{'username: '+staffObj.username +', password: '+ staffObj.password}}"><a class="tile-content ink ink-reaction" href="<?php echo base_url(); ?>index.php/staff/staffprofile/{{staffObj.id}}">{{staffObj.name}}</a></td>
    ...
    <script src="<?php echo base_url(); ?>/assets/myjs/staffkitgen.js?v=<?php echo rand(); ?>"></script>