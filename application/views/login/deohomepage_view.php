                                    ...
                                    <div class="card-body style-default-bright">
                                        <div class="col-xs-12">
                                            <table class="table table-condensed no-margin">
                                                ...
                                                <tbody>
                                                    <tr ng-repeat="staffDetail in staffData" ng-show="staffDetail.classTeacher!='-'">
                                                        <td><img class="img-circle width-1" src="<?php echo base_url() ?>index.php/staff/getphoto/{{staffDetail.id}}/THUMB" alt=""></td>
