                            ...
                            <div class="col-md-12">
                                <div class="card card-bordered style-primary">
                                    ...
                                    <div class="card-body style-default-bright">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6"> 
                                                                <form class="form-inline">
                                                                    ...
                                                                    <a href="<?php echo base_url(); ?>index.php/activity/empactivityentry/{{entrydate}}"  class="btn btn-raised btn-default-light ink-reaction">Entry</a>
                                                                </form>
                                                            </div>
                                        ...
                                        $xcrud->fields("project_id,activity_id,remarks,hour_worked");
