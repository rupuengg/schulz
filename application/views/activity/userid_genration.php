                            ...
                            <div class="col-md-8">
                                <div class="card card-bordered style-primary">
                                    <div class="card-head card-head-xs">
                                        ...
                                        <header><i class="fa fa-fw fa-tag"></i>User List</header>
                                    </div><!--end .card-head -->
                                    <div class="card-body style-default-bright">
                                        ...
                                        $xcrud->columns("usrname,pass");
                                        $xcrud->fields("usrname,pass,login_activated,staff_id");
                                        $xcrud->label("usrname", "Username");
                                        $xcrud->label("pass", "Password");
                                        $xcrud->where("member_type", "COMPANY");
                                        $xcrud->label("staff_id", "Staff Name");
                                        $xcrud->relation('staff_id', 'company_staff_details', 'id', array("Name"));
                                        $xcrud->limit(25);
