...
angular.module('lms_myangucomplete', [])
        .directive('angucomplete', function ($parse, $http, $sce, $timeout, $interval) {
            return {
                restrict: 'EA',
                scope: {
                    "id": "@id",
                ...
                link: function ($scope, elem, attrs) {
                    $scope.myCustomScope = "Hello Ashish";
                    ...
                    $scope.selectResult = function (result) {
                        ...
                        if ($scope.selectedObject != null) {
                            $scope.bookdetails = $scope.selectedObject.originalObject;
                            $http({
                                method: 'POST',
                                url: myURL + 'index.php/staff/bookquantitydetail',
                                data: 'data=' + encodeURIComponent(angular.toJson($scope.selectedObject.originalObject.book_no)),
                                headers: {'Content-Type': 'application/x-www-form-urlencoded'}
                            }).success(function (jsondata) {
                                $scope.bookdetails.searchdata = jsondata;
                                $http({
                                    method: 'POST',
                                    url: myURL + 'index.php/staff/bookquantitydetail',
                                    data: 'data=' + encodeURIComponent(angular.toJson($scope.selectedObject.originalObject.book_no)),
